...
date: 2023-11-19 16:29:19.090200
abstracts: 本文详细介绍了如何使用正向代理技术，通过配置代理服务器和客户端，实现在不配置代理的目标机器上访问 GitHub、Google 等外部资源的方法。文章还详细讲解了在 Ubuntu 22.04 上使用 shadowsocks 工具实现代理服务器的步骤，包括服务端和客户端的配置，以及 IPV6 绕过校园网、机场代理等高级方法。
categories: 学术科研,工程技术,文化娱乐
tags:
- 正向代理
- 流量转发
- 代理服务器
...
![](../img/正向代理/UXRJbdsjyo7btdxYFTZcxmfKnKg.png)

![](../img/正向代理/GB6kb5SQko1RKCx88NKcxJStnJd.png)
...
![](../img/正向代理/S4rRbLetGovvSFxa9gdc3K1tnJc.png)
...
![](../img/正向代理/VYqnbLXZxoqYoCxnlQCcXvjdnKb.png)
...
![](../img/正向代理/L1k3bryaeoBCqVxJhkhc5v1Knmh.png)
...
![](../img/正向代理/WR4Bbd2N7oXnqBxa8iAck7bAnQc.png)
...
![](../img/正向代理/Lw9AbE6mYolsSIxTY5Bca37Qnld.png)
...
![](../img/正向代理/GYOjbsZ6fodTGOxTzc8cFUCpnLf.png)
...
![](../img/正向代理/UJ1Xb6t1coVkbHxKbzec09iwn1b.png)
...
![](../img/正向代理/TkJubjtDwoU8cjx0duzc0EisnVf.png)
...
![](../img/正向代理/X9WYbdbC7oujfCxW7wccxjJ0nnb.png)

如果换了 terminal，只需要输入命令 `source /etc/profile.d/clash.sh` 即可正常使用。此时可以科学上网：

![](../img/正向代理/UNRZb7NMroF3SvxUkqrcFNn0nGf.png)
...
![](../img/正向代理/XrjPbPWlLoufeHxH3MHctW3Pnff.png)

切换到安全组选项卡，点击配置规则：

![](../img/正向代理/BiftbG5yko7OHCxVOd3cIuT0naf.png)

ECS 默认出方向无需配置，能够从 ECS 服务器转发所有流量包，需要配置进入服务器的流量，即入方向：

![](../img/正向代理/SCkxbCGSnofThdxcAsucX3dHnmg.png)

添加规则如下，注意端口范围手动输入 9090，授权对象为 0.0.0.0/0 允许任何 IP 访问，其他默认即可，点击保存。

![](../img/正向代理/PkWSb9nBuoMBLix36pWcNYnvncd.png)
